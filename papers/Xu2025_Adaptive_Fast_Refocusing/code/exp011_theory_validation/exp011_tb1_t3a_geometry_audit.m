function results = exp011_tb1_t3a_geometry_audit(run_mode)
%EXP011_TB1_T3A_GEOMETRY_AUDIT
...
cfg = config_exp011_tb1_t3a_geometry_audit(run_mode);

fprintf('\n============================================================\n');
fprintf('EXP011-A / TB1-T3A Retrospective Objective-Geometry Audit\n');
fprintf('============================================================\n');
fprintf('Run mode              : %s\n',cfg.run_mode);
...
q = cfg.global_search_lo_bins: ...
    cfg.geometry_grid_step_bins:cfg.global_search_hi_bins;
...
fprintf(fid,'EXP011-A / THEORY BRIDGE 1 / T3A\n');
...
xlabel('Continuous margin M_{cb}');
ylabel('Effective coarse margin \tilde{M}_{cb}');
...
xlabel('Fractional-bin offset \eta (bin)');
ylabel('Effective coarse margin \tilde{M}_{cb}');
